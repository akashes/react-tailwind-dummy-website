...
const Services = () => {
  return (
    ...
    <div className='w-[90%] mx-auto rounded-lg overflow-hidden  shadow-black shadow-lg sm:shadow-md sm:w-[100%] sm:mx-0 sm:rounded-none  sm:h-[12vh]  bg-black text-white flex flex-col gap-5 sm:gap-0 sm:flex-row justify-evenly items-center'>
